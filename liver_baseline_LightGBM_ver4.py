...
# 元のdfとX_polynomialとmerge
X_polynomial['id'] = df['id']
ori_col = ['id','Age','T_Bil','D_Bil','ALP','ALT_GPT','AST_GOT','TP','Alb','AG_ratio']
df = df.merge(X_polynomial, on = ori_col, how = 'left')
...
# CSVファイルの出力
sub.to_csv('./submit/liver_LightGBM_ver4.csv', header=None, index=False)
